...
public interface IShortX extends android.os.IInterface
{
  ...
  public static class Default implements tornaco.apps.shortx.core.IShortX
  {
    ...
    @Override public void setKeyDetectorLongPressTimeoutMS(long timeout) throws android.os.RemoteException
    {
    }
    @Override public long getKeyDetectorLongPressTimeoutMS() throws android.os.RemoteException
    {
      return 0L;
    }
    @Override
  ...
  public static abstract class Stub extends android.os.Binder implements tornaco.apps.shortx.core.IShortX
  {
    ...
    @Override public boolean onTransact(int code, android.os.Parcel data, android.os.Parcel reply, int flags) throws android.os.RemoteException
    {
      ...
      switch (code)
      {
        ...
        case TRANSACTION_setKeyDetectorLongPressTimeoutMS:
        {
          data.enforceInterface(descriptor);
          long _arg0;
          _arg0 = data.readLong();
          this.setKeyDetectorLongPressTimeoutMS(_arg0);
          reply.writeNoException();
          return true;
        }
        case TRANSACTION_getKeyDetectorLongPressTimeoutMS:
        {
          data.enforceInterface(descriptor);
          long _result = this.getKeyDetectorLongPressTimeoutMS();
          reply.writeNoException();
    ...
    private static class Proxy implements tornaco.apps.shortx.core.IShortX
    {
      ...
      @Override public void onHookedMethodCalled(tornaco.apps.shortx.core.rule.action.ByteArrayWrapper hook, java.util.List<tornaco.apps.shortx.core.rule.action.ByteArrayWrapper> methodArgs) throws android.os.RemoteException
      {
        ...
        try {
          ...
          if ((hook!=null)) {
            _data.writeInt(1);
            hook.writeToParcel(_data, 0);
          }
          else {
            _data.writeInt(0);
          }
          _data.writeTypedList(methodArgs);
          boolean _status = mRemote.transact(Stub.TRANSACTION_onHookedMethodCalled, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            getDefaultImpl().onHookedMethodCalled(hook, methodArgs);
            return;
          }
          _reply.readException();
        }
      ...
      @Override public android.os.ParcelFileDescriptor getMethodHookLogFD() throws android.os.RemoteException
      {
        ...
        try {
          ...
          if (!_status && getDefaultImpl() != null) {
            return getDefaultImpl().getMethodHookLogFD();
          }
          _reply.readException();
          if ((0!=_reply.readInt())) {
            _result = android.os.ParcelFileDescriptor.CREATOR.createFromParcel(_reply);
      ...
      @Override public java.lang.String getMethodHookLogPath() throws android.os.RemoteException
      {
        ...
        try {
          ...
          if (!_status && getDefaultImpl() != null) {
            return getDefaultImpl().getMethodHookLogPath();
          }
          _reply.readException();
          _result = _reply.readString();
        }
      ...
      @Override public void clearMethodHookLogs() throws android.os.RemoteException
      {
        ...
        try {
          ...
          if (!_status && getDefaultImpl() != null) {
            getDefaultImpl().clearMethodHookLogs();
            return;
          }
          _reply.readException();
        }
      ...
      @Override public void setKeyDetectorLongPressTimeoutMS(long timeout) throws android.os.RemoteException
      {
        ...
        try {
          ...
          boolean _status = mRemote.transact(Stub.TRANSACTION_setKeyDetectorLongPressTimeoutMS, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            getDefaultImpl().setKeyDetectorLongPressTimeoutMS(timeout);
            return;
          }
          _reply.readException();
        }
      ...
      @Override public long getKeyDetectorLongPressTimeoutMS() throws android.os.RemoteException
      {
        ...
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          boolean _status = mRemote.transact(Stub.TRANSACTION_getKeyDetectorLongPressTimeoutMS, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            return getDefaultImpl().getKeyDetectorLongPressTimeoutMS();
          }
          _reply.readException();
    ...
    static final int TRANSACTION_setKeyDetectorLongPressTimeoutMS = (android.os.IBinder.FIRST_CALL_TRANSACTION + 188);
    static final int TRANSACTION_getKeyDetectorLongPressTimeoutMS = (android.os.IBinder.FIRST_CALL_TRANSACTION + 189);
  ...
  public void setKeyDetectorLongPressTimeoutMS(long timeout) throws android.os.RemoteException;
  public long getKeyDetectorLongPressTimeoutMS() throws android.os.RemoteException;
}

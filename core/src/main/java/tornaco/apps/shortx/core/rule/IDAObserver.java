...
public interface IDAObserver extends android.os.IInterface
{
  /** Default implementation for IDAObserver. */
  public static class Default implements tornaco.apps.shortx.core.rule.IDAObserver
  {
  ...
  public static abstract class Stub extends android.os.Binder implements tornaco.apps.shortx.core.rule.IDAObserver
  {
    ...
    /**
     * Cast an IBinder object into an tornaco.apps.shortx.core.rule.IDAObserver interface,
     * generating a proxy if needed.
     */
    public static tornaco.apps.shortx.core.rule.IDAObserver asInterface(android.os.IBinder obj)
    {
      if ((obj==null)) {
        return null;
      }
      android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
      if (((iin!=null)&&(iin instanceof tornaco.apps.shortx.core.rule.IDAObserver))) {
        return ((tornaco.apps.shortx.core.rule.IDAObserver)iin);
      }
      return new tornaco.apps.shortx.core.rule.IDAObserver.Stub.Proxy(obj);
    }

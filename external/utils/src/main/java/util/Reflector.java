...
public final class Reflector {
    public final ClassLoader BOOTCLASSLOADER = ClassLoader.getSystemClassLoader();
    ...
    private final HashMap<String, Constructor<?>> constructorCache = new HashMap<String, Constructor<?>>();
    private final WeakHashMap<Object, HashMap<String, Object>> additionalFields = new WeakHashMap<Object, HashMap<String, Object>>();
    private final HashMap<String, ThreadLocal<AtomicInteger>> sMethodDepth = new HashMap<String, ThreadLocal<AtomicInteger>>();
    ...
    private Field findFieldRecursiveImpl(Class<?> clazz, String fieldName) throws NoSuchFieldException {
        try {
     ...
     */
    private Class<?>[] getParameterClasses(ClassLoader classLoader, Object[] parameterTypesAndCallback) {
        ...
        for (int i = parameterTypesAndCallback.length - 1; i >= 0; i--) {
            ...
            if (type.getClass().getSimpleName().equals("XC_MethodHook")) {
                continue;
            }
    ...
    private String getParametersString(Class<?>... clazzes) {
    ...
    public final class ClassNotFoundError extends Error {
        private final long serialVersionUID = -1070936889459514628L;
    ...
    /**
     * Sets the value of a  object field in the given class. See also {@link #findField}.
     */
    ...
    /**
     * Sets the value of a  {@code boolean} field in the given class. See also {@link #findField}.
     */
    ...
    /**
     * Sets the value of a  {@code byte} field in the given class. See also {@link #findField}.
     */
    ...
    /**
     * Sets the value of a  {@code char} field in the given class. See also {@link #findField}.
     */
    ...
    /**
     * Sets the value of a  {@code double} field in the given class. See also {@link #findField}.
     */
    ...
    /**
     * Sets the value of a  {@code float} field in the given class. See also {@link #findField}.
     */
    ...
    /**
     * Sets the value of a  {@code int} field in the given class. See also {@link #findField}.
     */
    ...
    /**
     * Sets the value of a  {@code long} field in the given class. See also {@link #findField}.
     */
    ...
    /**
     * Sets the value of a  {@code short} field in the given class. See also {@link #findField}.
     */
    ...
    /**
     * Returns the value of a  object field in the given class. See also {@link #findField}.
     */
    ...
    /**
     * Returns the value of a  {@code boolean} field in the given class. See also {@link #findField}.
     */
    ...
    /**
     * Calls an instance or  method of the given object.
     ...
     */
    public Object callMethod(Object obj, String methodName, Class<?>[] parameterTypes, Object... args) {
        try {
    ...
    /**
     * Calls a  method of the given class.
     * The method is resolved using {@link #findMethodBestMatch(Class, String, Object...)}.
     *
     ...
     * methods with the same name, especially if you call it with {@code null} parameters.
     */
    public Object callStaticMethod(Class<?> clazz, String methodName, Class<?>[] parameterTypes, Object... args) {
        try {
    ...
    private ThreadLocal<AtomicInteger> getMethodDepthCounter(String method) {

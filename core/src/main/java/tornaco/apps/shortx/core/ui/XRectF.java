...
public class XRectF {
     ...
     */
    public XRectF(float left, float top, float right, float bottom) {
        this.left = left;
        this.top = top;
        this.right = right;
        this.bottom = bottom;
     ...
     *          rectangle.
     */
    public XRectF(@Nullable XRectF r) {
        if (r == null) {
     ...
     *            rectangle.
     */
    public void set(@NonNull XRectF src) {
        this.left = src.left;
        this.top = src.top;
     ...
     * rectangle
     */
    public boolean contains(@NonNull XRectF r) {
        // check for empty first
        return this.left < this.right && this.top < this.bottom
                // now check for containment
     ...
     * return false and do not change this rectangle.
     */
    public boolean intersect(@NonNull XRectF r) {
     ...
     */
    public boolean setIntersect(@NonNull XRectF a, @NonNull XRectF b) {
     ...
     */
    public static boolean intersects(@NonNull XRectF a, @NonNull XRectF b) {
     ...
     */
    public void union(@NonNull XRectF r) {

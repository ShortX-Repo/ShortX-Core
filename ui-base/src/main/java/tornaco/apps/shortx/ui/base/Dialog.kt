...
fun RebootConfirmDialog(
    ...
    if (state.isShowing) {
        ...
        ShortXAlertDialog(
            ...
            confirmButton = {
                TextButton(onClick = {
                    shortXManager.reboot("RebootConfirmDialog")
                    state.dismiss()
                }) {
            ...
            title = {
                Text(text = i18N["ui.common.reboot"])
            },
            text = {
                Text(text = i18N["ui.common.reboot.message"])
            })
    }
}
    ...
    if (state.isShowing) {
        ...
        ShortXAlertDialog(
            ...
            confirmButton = {
                TextButton(onClick = {
                    ...
                    state.textToCopy?.let {
                        ClipboardUtils.copyToClipboard(context, "key", it)
                    }
                }) {
                    Text(
            ...
            text = {
                ...
                MarkdownText(markdown = state.tip, color = textColor)
            })
    }
}

...
public interface IGlobalVarObserver extends android.os.IInterface
{
  ...
  {
    private static final java.lang.String DESCRIPTOR = "tornaco.apps.shortx.core.rule.IGlobalVarObserver";
    ...
    private static class Proxy implements tornaco.apps.shortx.core.rule.IGlobalVarObserver
    {
      ...
      public static tornaco.apps.shortx.core.rule.IGlobalVarObserver sDefaultImpl;
    }
    ...
    public static boolean setDefaultImpl(tornaco.apps.shortx.core.rule.IGlobalVarObserver impl) {
    ...
    public static tornaco.apps.shortx.core.rule.IGlobalVarObserver getDefaultImpl() {

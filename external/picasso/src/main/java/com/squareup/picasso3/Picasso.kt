...
class Picasso internal constructor(
    ...
    @get:JvmName("-cacheDir") internal val cacheDir: File,
    ...
    class Builder {
        ...
        fun build(): Picasso {
            ...
            if (callFactory == null) {
                val cacheDir = requireNotNull(cacheDir) {
                    "Pls set cacheDir first."
                }
            ...
            return Picasso(
                ...
                requireNotNull(cacheDir) {
                    "Pls set cacheDir on the Builder."
                },
                listener,
                requestTransformers,
                requestHandlers,
